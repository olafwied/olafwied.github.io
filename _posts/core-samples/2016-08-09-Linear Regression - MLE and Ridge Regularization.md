...
tagline: hands-on
tags : [Linear Regression, Ridge, Regularization, MLE, maximum likelihood]
mathjax: true
---
{% include JB/setup %}
...
$$=\sum_{i=1}^N \log \left[ \left( \frac{1}{2\pi\sigma^2}\right)^{\frac{1}{2}} \\exp \left( -\frac{1}{2\sigma^2}(y_i - w^Tx_i)^2\right)\right]$$
